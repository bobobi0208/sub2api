...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	providerPricingService := service.NewProviderPricingService(channelService, settingService)
	providerPricingHandler := handler.NewProviderPricingHandler(providerPricingService, configConfig)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, providerPricingHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
