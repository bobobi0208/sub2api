...
// 模型广场和可用渠道共用数据开关；保留老入口以降低上游合并冲突。
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/model-marketplace', label: t('nav.modelMarketplace'), icon: ChannelIcon, hideInSimpleMode: true, featureFlag: flagAvailableChannels },
