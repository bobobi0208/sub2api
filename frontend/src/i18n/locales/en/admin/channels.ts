export default {
    ...
    channels: {
      ...
      form: {
        ...
        models: 'Models',
        modelsPlaceholder: 'Search or type a model name',
        modelInputHint: 'Pick from the list, or type a name and press Enter to add a custom model.',
        noMatchingModels: 'No matching models',
        addAsCustomModel: 'Add "{model}" as custom model',
        loadingModels: 'Loading models...',
        catalogLoadError: 'Failed to load model catalog',
        billingMode: 'Billing Mode',
